...
function getAllWeekend() {
   var comp = [];
   comp2 = [];
    $.ajax({
        url: baseurl + "Configuration/GetWeekend",
        type: "GET",
        dataType: "json",
        ...
        success: function (res) {
            ...
            for (var i = 0; i < res.length; i++) {
                ...
                var str = ['' + (i + 1) + '', '' + res[i].facilities.facilityname  + '', '' + res[i].weekday ];
                var str2 = { 'sl': (i + 1), 'weekendid': res[i].weekendid, 'facilityId': res[i].facilityid, 'weekday': res[i].weekday };
...
$('body').on('click', '#btnEdit', function () {
  var dt= $('.datatables-basic').DataTable();
   ...
   var dta = comp2[ind];
   $('#weekendId').val(dta.weekendid);
   $('#hfacilityId').val(dta.facilityId);
   //$('#hweekday').val(dta.weekday);
...
$('body').on('click', '#btnDelete', function () {
    ...
    $.ajax({
        url: baseurl + "Configuration/DeleteWeekend",
        type: "GET",
        dataType: "json",
        contentType: 'application/json',
